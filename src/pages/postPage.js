...
export default function PostPage() {
    ...
    const handelDelete = async () => {
        const flag = window.confirm("Delete this post");
        if(flag){
            await fetch(`http://localhost:4000/delete/${postInfo._id}`);
        }
    }
    ...
    return (
        <>
            ...
            <div className="postPage-btns">
                ...
                <Link className="edit" onClick={handelDelete} to={`/`}>
                    <button>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
